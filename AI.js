...
// ไม่จำเป็นต้องใช้ currentDetectedClass และ detectionStartTime แล้ว เนื่องจากใช้ predictionHistory แทน
            ...
            if (topProbability > 0.7) { // ปรับค่า 0.7 ได้ตามความเหมาะสมสำหรับไฮไลท์
                ...
                if (isConsistentAndHighConfidence) {
                    ...
                    if (topClassName === "D2") {
                        ...
                        // ถ้าเป็น Class อื่นๆ ที่เข้าเงื่อนไข 3 วินาที 90% แต่ไม่ใช่ D1/D2
                        resultDisplayElement.innerHTML = `<h4>💡 โมเดลมั่นใจใน "${topClassName}" มากกว่า 3 วินาที!</h4><p>ความน่าจะเป็น: ${ (topProbability * 100).toFixed(1)}%</p>`;
                        resultDisplayElement.className = 'info-message';
                    }
                } else {
                    // ถ้ายังไม่ตรงเงื่อนไข 3 วินาที 90% ก็แสดงผลลัพธ์ปกติของคุณ
